package com.itang.mvvm.binding.viewadapter.view;
...
public class ViewAdapter {
     ...
     * view的显示隐藏
     */
    @BindingAdapter(value = {"isVisibleGone"}, requireAll = false)
    public static void isVisibleGone(View view, final Boolean isVisibleGone) {
        if (isVisibleGone) {
